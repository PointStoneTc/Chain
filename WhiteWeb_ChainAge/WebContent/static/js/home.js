...
var homePage = {
    ...
    init: function () {
        Common.getHomeData(function(data){
            ...
            homePage.newsListShow(data.postMap["100"],$('.news_list_con .news_container'));
            homePage.newsListShow(data.postMap["103"],$('.teji_list .news_container'));
            homePage.newsListShow(data.postMap["148"],$('.channel_list .news_container'));
        });
    ...
    newsListShow:function(data,element){
        ...
        if (data.length > 0) {
            for (var i = 0; i < data.length; i++) {
                ...
                var imgUrl=data[i].author.avatar_urls["24"];
                htm += '<div class="col-md-4 benefit_box"><a href="'+ './newsContent.html?id=' + data[i].id+'">'
                    ...
                    +'<span class="new_list_icon"><img src="'+imgUrl+'"></span>'
