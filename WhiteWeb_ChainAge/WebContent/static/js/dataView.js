var dataList = [];
for (var i = 0; i < 32; i++) {
    dataList.push('<a data-key="CSPA:BTC/AED" href="/zh/market/btc-aed/">',
        '<div class="code"><span>BTC/</span><span>AED</span></div>',
        '<div class="price">23,0910</div>',
        '<div class="price-change up">',
        '<span><span class="n-sign">+</span>',
        '<span class="n-integer n-zero">0.88%</span>',
        '</div>',
        '</a>');
}
